...
public class ResultList<T> extends AbstractResult {
    ...
    public static <T> ResultList<T> error() {
        return new ResultList(Constant.FAIL, Constant.SYS_ERROR);
    }

    @SuppressWarnings(value = "unchecked")
    public static <T> ResultList<T> error(String code) {
        return new ResultList(code, Constant.SYS_ERROR);
    }

    @SuppressWarnings(value = "unchecked")
    public static <T> ResultList<T> error(String code, String message) {
        return new ResultList(code, message);
    }

    @SuppressWarnings(value = "unchecked")
    public static <T> ResultList<T> list(Page<T> datas) {
        ResultList<T> res =  new ResultList(Constant.SUCCESS, null);
